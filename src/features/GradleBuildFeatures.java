...
public class GradleBuildFeatures {
	...
	private static final String ASYNCHTTPERWEITERUNG = "compile 'com.loopj.android:android-async-http:1.4.4'";
	...
	public void setAppDependencies() {
		try {
			FileReader fileIn = new FileReader(
					md2Pfad + "\\testprojekt.androidLollipop\\md2_app_TestprojektApp\\app\\build.gradle");
			BufferedReader bufIn = new BufferedReader(fileIn);
